	  ...
	  module.factory('ModalService', ['$animate', '$document', '$compile', '$controller', '$http', '$rootScope', '$q', '$templateRequest', '$timeout', function ($animate, $document, $compile, $controller, $http, $rootScope, $q, $templateRequest, $timeout) {
	    ...
	    function ModalService() {
	      ...
	      self.showModal = function (options) {
	        ...
	        if (!controllerName) {
	          deferred.reject("No controllers has been specified.");
	          return deferred.promise;
	        }
	        ...
	        getTemplate(options.template, options.templateUrl).then(function (template) {
	          ...
	          //  Create the inputs object to the controllers - this will include
	          //  the scope, as well as all inputs provided.
	          //  We will also create a deferred that is resolved with a provided
	          //  close function. The controllers can then call 'close(result)'.
	          //  The controllers can also provide a delay for closing - this is
	          ...
	          //  If we have provided any inputs, pass them to the controllers.
	          ...
	          //  Create the controllers, explicitly specifying the scope to use.
...
/***/ }
/******/ ]);
//# sourceMappingURL=angular-modal-services.js.map